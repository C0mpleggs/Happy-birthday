...
function preload() {
	...
	ethnocentric = loadFont("fonts/ethnocentric/ethnocentric rg.otf");
}
...
function draw() {
	...
	fill(211, 84, 0);
	textSize(25);
	text('Happy Birthday', windowWidth/2, windowHeight/3);
	textSize(35);
	text('to the greatest friend', windowWidth/2, windowHeight/2)
	textSize(20);
	text('Nallu suresh', windowWidth/2 , (windowHeight*4)/5);
	if(random(1) < 0.03) {
